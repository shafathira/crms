...
@section('content')
    ...
    <div class="col-md-10 text-center ml-auto mr-auto">
        <h3 class="mb-5">Course Request Management System</h3>
    </div>
        ...
        <form class="form" method="post" action="{{ route('login') }}">
            ...
            <div class="card card-login card-white">
                <div class="card-header">
                    <img src="{{ asset('assets/img/logo-crms.jpg') }}" style="width: 100%" >
                    <br><br>
                ...
                <div class="card-footer">
                    ...
                    <div class="float-left">
                        <h6>
                            <a href="{{ route('register') }}" class="link footer-link">{{ __('Register Here') }}</a>
                        </h6>
                    </div>
